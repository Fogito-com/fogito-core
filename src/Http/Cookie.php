...
use Fogito\Session\AdapterInterface as SessionInterface;
...
class Cookie
{
     ...
     * Filter
     *
     * @var null|\Fogito\FilterInterface
     * @access protected
     */
    protected $_filter;
    ...
    /**
     * \Fogito\Http\Cookie constructor
     *
     * @param string $name
     * @param string $value
     ...
     *
     * @param string $value
     * @return \Fogito\Http\CookieInterface
     * @throws Exception
     */
